...
Investiga en qué consiste la \textit{Forma Normal de Chomsky}. Selecciona alguna de las gramáticas con las que hemos trabajado anteriormente y llévala a esta forma.\\
\\
\solution\\
\\
Dada la gramática:
Cadenas de bits {o,1} que empiezan con 0 y terminan con 1.\\
$T = \{ 0, 1 \}$\\
$S ::= OE1$\\
$E ::= 0 | 1 | \epsilon | EE$\\
\\
